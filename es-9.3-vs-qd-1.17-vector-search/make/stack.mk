...
include $(REPO_ROOT)/make/inc/terraform.mk
include $(REPO_ROOT)/make/inc/gke-connect.mk
include $(REPO_ROOT)/make/inc/jingra-jobs.mk
include $(REPO_ROOT)/make/inc/logs-common.mk
include $(REPO_ROOT)/make/inc/stack-secrets.mk
include $(REPO_ROOT)/make/inc/stack-status.mk
include $(REPO_ROOT)/make/inc/stack-access.mk

.PHONY: k8s-apply k8s-delete

ifeq ($(STACK),elasticsearch)
...
k8s-apply: secrets-create
	...
	kubectl apply -f $(STACK_DIR)k8s-cluster.yml
...
k8s-delete: connect-k8s
	kubectl delete -f $(STACK_DIR)k8s-cluster.yml --ignore-not-found
...
else ifeq ($(STACK),qdrant)

.PHONY: ensure-qdrant-api-key-in-env
